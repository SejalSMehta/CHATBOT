...
namespace SpeechBot1.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        {
            if (string.IsNullOrEmpty(Configuration["3ad25541-71af-4a2e-b968-1a9e8db3e31c"]) || string.IsNullOrEmpty(Configuration["503c0c9b7ef34c35bd4ec89a2d02b57c"]) || string.IsNullOrEmpty(Configuration["https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/"]))
            {
        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
           ...
           // var bookingDetails = stepContext.Result != null
            ...
            return await stepContext.BeginDialogAsync(nameof(AuthenticateDialog), null, cancellationToken);
